...
public class QingFenZhouZhuanJiaoJie_db extends FragmentActivity implements
		OnClickListener {
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			switch (msg.what) {
			case 0:
				manager.getAbnormal().timeout(QingFenZhouZhuanJiaoJie_db.this,
						"验证超时,重试?", OnClick1);
				break;
			case 1:
				manager.getAbnormal().timeout(QingFenZhouZhuanJiaoJie_db.this,
				...
				if (!firstSuccess && !"1".equals(f1)) {
					...
					if (right_name != null && right_name.equals(left_name)) {
						...
						manager.getRuning().runding(
								QingFenZhouZhuanJiaoJie_db.this, "数据提交中...");
						Jiaojie();
					}
				}
				break;
			case 3:
				...
				if (wrongleftNum >= ShareUtil.three) {
					// 左侧跳用户登录
					firstSuccess = false;
					intent.setClass(QingFenZhouZhuanJiaoJie_db.this,
							QingFenYuanDengLu.class);
					QingFenZhouZhuanJiaoJie_db.this.startActivityForResult(
							intent, 1);
					top_tishi.setText("");
					wrongleftNum = 0;
			...
			case 4:
				...
				cashBoxNum = "";
				userId = "";
				Skip.skip(QingFenZhouZhuanJiaoJie_db.this,
						RenWuLieBiao_db.class, null, 9);
				break;
			case 5:
				manager.getRuning().remove();
				manager.getAbnormal().timeout(QingFenZhouZhuanJiaoJie_db.this,
